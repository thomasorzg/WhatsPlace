...
class LandingPageSectionsController extends Controller
{
    ...
    public function setConetent(Request $request)
    {
        if(\Auth::user()->type == 'super admin')
        {
            ...
            if(!is_null($get_section)){
                ...
                $Landing_page_section = LandingPageSections::findOrfail($get_section->id);
     ...
     *
     * @param  \App\LandingPageSections  $landingPageSections
     * @return \Illuminate\Http\Response
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(LandingPageSections $landingPageSections)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, LandingPageSections $landingPageSections)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(LandingPageSections $landingPageSections)
    {
        //
    }
}
