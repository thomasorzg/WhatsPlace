    ...
    <div class="min-vh-100 h-100vh py-5 d-flex align-items-center bg-gradient-danger">
        ...
        <div class="container position-relative zindex-100">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <h6 class="display-1 mb-3 font-weight-600 text-white">{{__('500')}}</h6>
                    <p class="lead text-lg text-white mb-5">
                        {{__("Sorry something has gone wrong on the websites server.")}}
                    </p>
                    @if(\Auth::check())
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <figure class="w-100">
                        <img alt="Image placeholder" src="{{ asset('assets/img/server-down.svg') }}" class="svg-inject opacity-8 img-fluid" style="height: 500px;">
                    </figure>
                </div>
            </div>
        </div>
