                ...
                <div class="card ">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 proprice">
                                <div class="form-group">
                                    {{Form::label('quantity',__('Stock Quantity'),array('class'=>'form-control-label')) }}
                                    {!! Form::text('quantity',null,array('class'=>'form-control','placeholder'=>__('Enter Stock Quantity'))) !!}
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="downloadable_prodcut" class="form-control-label font-bold-700">{{ __('Downloadable Product') }}</label>
                                                                    ...
                                                                    @foreach($productVariantArrays as $counter => $productVariant)
                                                                        <tr data-id="{{$productVariant['product_variants']['id']}}">
                                                                            ...
                                                                            <td class="d-flex align-items-center mt-3 border-0">
                                                                                <a href="#" class="action-item" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-p-variant-{{$productVariant['product_variants']['id']}}').submit();">
