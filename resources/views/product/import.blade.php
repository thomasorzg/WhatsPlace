    ...
    <div class="row">
        <div class="col-md-12 mb-6">
            ...
            <a href="{{asset(Storage::url('uploads/sample')).'/sample-product.xlsx'}}" class="choose-file btn boxbtn fluid shadow-sm btn-primary rounded-6 d-inline-flex align-items-center">
